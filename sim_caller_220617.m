function sim_caller_220617(otherpars)
% MI in 85/87 mixture
...
% File names
file_prefix     = '/mnt/dataDrive2/ModulationalInstability/250517_CapillaryInstab_TheoryWorkForStuart/250517_capillaryInstability_TheoryWork_3D_groundstate'; %'/short/iq20/ms2031/220517_CapillaryInstability_Full3D/220517_test';
...
if isempty(otherpars)==false
    for i=1:numel(otherpars)
        pars = setfield(pars,otherpars{i}{1},otherpars{i}{2});
    end
end
