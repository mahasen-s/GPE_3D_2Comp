function sim_caller_230517_nograv
% MI in 85/87 mixture
...
% File names
file_prefix     = '/mnt/dataDrive2/ModulationalInstability/240517_CapillaryInstab_3D_nograv/230517_nograv';
...
pars    = appendfields(pars,...
            ...
            'sampleTimes',1e-3*linspace(0,80,200),...
...
pars.fileIn         = gsFile;
pars.fileOut        =   strrep([file_prefix,sprintf('8587_prop_as=%4.1fa0_Aym',pars.scat_init_85)],'.','p');
pars.propMode       = 'init';
